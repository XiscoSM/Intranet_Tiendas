...
/// <summary>
/// Migración de IntranetTiendas/InformeManualLin0.asp (detalle de informe manual, tipo 0).
...
/// </summary>
public class InformeManualLin0Model(DbService db) : BasePageModel(db)
{
    ...
    public async Task<IActionResult> OnGetExcelAsync()
    {
        ...
        return Excel(rows, "InformeManualLin0");
    }
}
