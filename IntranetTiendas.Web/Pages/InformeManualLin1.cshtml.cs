...
/// <summary>
/// Migración de IntranetTiendas/InformeManualLin1.asp (detalle de informe manual, tipo 1: stock/compra/pvp).
...
/// </summary>
public class InformeManualLin1Model(DbService db) : BasePageModel(db)
{
    ...
    public async Task<IActionResult> OnGetExcelAsync()
    {
        ...
        return Excel(rows, "InformeManualLin1");
    }
}
