...
/// <summary>
/// Migración de IntranetTiendas/InformeManualLin2.asp (detalle de informe manual, tipo 2).
...
/// </summary>
public class InformeManualLin2Model(DbService db) : BasePageModel(db)
{
    ...
    public async Task<IActionResult> OnGetExcelAsync()
    {
        ...
        return Excel(rows, "InformeManualLin2");
    }
}
