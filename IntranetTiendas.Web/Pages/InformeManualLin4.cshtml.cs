...
/// <summary>
/// Migración de IntranetTiendas/InformeManualLin4.asp (detalle de informe manual, tipo 4: solo cantidades).
...
/// </summary>
public class InformeManualLin4Model(DbService db) : BasePageModel(db)
{
    ...
    public async Task<IActionResult> OnGetExcelAsync()
    {
        ...
        return Excel(rows, "InformeManualLin4");
    }
}
