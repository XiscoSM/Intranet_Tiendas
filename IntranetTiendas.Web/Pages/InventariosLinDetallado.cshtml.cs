...
/// <summary>
/// Migración de IntranetTiendas/InventariosLin(detallado).asp.
/// Procedures: asp.PROC_MovInventarioLin_Select.
/// P2 = fecha del inventario, P3 = programa (@Prog numérico, default NULL conservado),
/// P4 = diferencia mínima: en esta variante el filtro del ASP era estricto
/// (ABS(ImporteCosteDif) &gt; P4, a diferencia de InventariosLin que usa &gt;=).
/// El formulario de filtro envía a /InventariosLin, igual que el original.
/// </summary>
public class InventariosLinDetalladoModel(DbService db) : BasePageModel(db)
{
