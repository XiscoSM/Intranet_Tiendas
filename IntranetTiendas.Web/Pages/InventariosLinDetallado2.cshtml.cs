...
/// <summary>
/// Migración de IntranetTiendas/InventariosLin(detallado)2.asp.
/// Procedures: asp.PROC_MovInventarioLin_Select.
/// Idéntica a InventariosLinDetallado (filtro estricto ABS(ImporteCosteDif) &gt; P4)
/// pero con cabecera adicional de ordenación cliente (sortTable) sobre Prod/Descripcion.
/// El formulario de filtro envía a /InventariosLin, igual que el original.
/// </summary>
public class InventariosLinDetallado2Model(DbService db) : BasePageModel(db)
{
