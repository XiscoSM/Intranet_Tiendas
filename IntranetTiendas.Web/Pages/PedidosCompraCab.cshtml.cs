...
/// <summary>
/// Migración de IntranetTiendas/PedidosCompraCab.asp.
/// Procedure: asp.PROC_PedidoCompraCab_Select_Alm.
...
/// </summary>
public class PedidosCompraCabModel(DbService db) : BasePageModel(db)
{
    ...
    {
        Pedidos = await Db.QueryProcAsync("asp.PROC_PedidoCompraCab_Select_Alm",
    ...
    {
        var rows = await Db.QueryProcAsync("asp.PROC_PedidoCompraCab_Select_Alm",
            new { Empresa, Alm, FechaTop, PedidoTop });
        return Excel(rows, "PedidosCompra");
    }
}
