...
/// <summary>
/// Migración de IntranetTiendas/PedidosCompraLin.asp (detalle imprimible de un pedido de compra).
/// Procedures: asp.PROC_PedidoCompraLin_Select (líneas), asp.PROC_PedidoCompraCab_Select (cabecera).
/// Parámetros de URL P2 (fecha) y P3 (pedido) se conservan para mantener los enlaces desde
/// PedidosCompraCab / PedidosCompraCabPend. La acción "Marcar como Recepcionado" enlaza a
/// /Accion?Proc=4 (antes "Ejecuta procedure.asp").
/// </summary>
public class PedidosCompraLinModel(DbService db) : BasePageModel(db)
{
